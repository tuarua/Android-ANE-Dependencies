...
set CLASSPATH=%APP_HOME%\lib\sdk-common-26.0.0-dev.jar;%APP_HOME%\lib\manifest-merger-26.0.0-dev.jar;%APP_HOME%\lib\commons-logging-1.1.1.jar;%APP_HOME%\lib\common-26.0.0-dev.jar
